FancyBackbone.Views.Insights.ContentView = Backbone.View.extend({
  template: FancyBackbone.Utils.loadTemplate('insights_content_view'),
  tagName: 'div',
  id: 'content',
  ...
  getChartViewClass: function() {
    if (this.chartType == 'map') {
      return FancyBackbone.Views.Insights.MapChartView;
    } else {
      return FancyBackbone.Views.Insights.AreaChartView;
    }
  },
  ...
  renderContents: function() {
    ...
    $.when.apply($, dfds).done(function() {
      that.controllerView = new FancyBackbone.Views.Insights.ControllerView({
        model: that.summary,
      ...
      that.trafficOverallView = new FancyBackbone.Views.Insights.TrafficOverallView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.trafficFancyView = new FancyBackbone.Views.Insights.TrafficFancyView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.mostSearchedView = new FancyBackbone.Views.Insights.MostSearchedView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.mostImpressionView = new FancyBackbone.Views.Insights.MostImpressionView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.mostActiveView = new FancyBackbone.Views.Insights.MostActiveView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.mostPopularView = new FancyBackbone.Views.Insights.MostPopularView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
