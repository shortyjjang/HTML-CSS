...
FancyBackbone.Views.EuropisteInsights.ControllerView = Backbone.View.extend({
...
FancyBackbone.Views.EuropisteInsights.BaseChartView = Backbone.View.extend({
  className: "data loading",
  template: FancyBackbone.Utils.loadTemplate('europiste_insights_chart_view'),
  events: {
...
FancyBackbone.Views.EuropisteInsights.MapChartView = FancyBackbone.Views.EuropisteInsights.BaseChartView.extend({
...
FancyBackbone.Views.EuropisteInsights.AreaChartView = FancyBackbone.Views.EuropisteInsights.BaseChartView.extend({
...
FancyBackbone.Views.EuropisteInsights.BestSellerView = Backbone.View.extend({
  tagName: 'div',
...
FancyBackbone.Views.EuropisteInsights.View = Backbone.View.extend({
  initialize: function() {
    this.contentView = new FancyBackbone.Views.EuropisteInsights.ContentView();
  },
