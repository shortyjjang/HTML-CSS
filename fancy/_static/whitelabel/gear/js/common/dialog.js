jQuery(function($){
    ...
    var $win = $(window), $body = $('body'),$html = $('html');

    $container
        .on('click', function(event){
            if(event.target === this && prev_dialog) {
                if ($container.hasClass('sign') || $container.hasClass('redeem-giftcard')) return;
    ...
    $.dialog = function(popup_name){
        ...
        return {
            ...
            loading : function() {
                ...
                setTimeout(function(){ $html.addClass('popup-on');$c.css('opacity',1); },1);
                this.$obj.hide();
                prev_dialog = this;
