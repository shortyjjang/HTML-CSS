...
FancyBackbone.Views.Admin.Merchant.MerchantAdmin.PaginationView = FancyBackbone.Views.Base.TemplateView.extend({
    template: FancyBackbone.Utils.loadTemplate("merchant_admin_pagination"),
    templateHelpers: {
