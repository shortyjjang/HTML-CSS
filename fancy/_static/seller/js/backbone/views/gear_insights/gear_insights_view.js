...
FancyBackbone.Views.GearInsights.ControllerView = Backbone.View.extend({
...
FancyBackbone.Views.GearInsights.BaseChartView = Backbone.View.extend({
  className: "data loading",
  template: FancyBackbone.Utils.loadTemplate('gear_insights_chart_view'),
  events: {
...
FancyBackbone.Views.GearInsights.MapChartView = FancyBackbone.Views.GearInsights.BaseChartView.extend({
...
FancyBackbone.Views.GearInsights.AreaChartView = FancyBackbone.Views.GearInsights.BaseChartView.extend({
...
FancyBackbone.Views.GearInsights.BestSellerView = Backbone.View.extend({
  tagName: 'div',
...
FancyBackbone.Views.GearInsights.View = Backbone.View.extend({
  initialize: function() {
    this.contentView = new FancyBackbone.Views.GearInsights.ContentView();
  },
