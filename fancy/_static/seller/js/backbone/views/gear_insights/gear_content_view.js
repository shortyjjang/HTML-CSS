FancyBackbone.Views.GearInsights = FancyBackbone.Views.GearInsights || {};
FancyBackbone.Views.GearInsights.ContentView = Backbone.View.extend({
  template: FancyBackbone.Utils.loadTemplate('gear_insights_content_view'),
  tagName: 'div',
  id: 'content',
  ...
  getChartViewClass: function() {
    if (this.chartType == 'map') {
      return FancyBackbone.Views.GearInsights.MapChartView;
    } else {
      return FancyBackbone.Views.GearInsights.AreaChartView;
    }
  },
  ...
  renderContents: function() {
    ...
    $.when.apply($, dfds).done(function() {
      that.controllerView = new FancyBackbone.Views.GearInsights.ControllerView({
        model: that.summary,
      ...
      that.trafficOverallView = new FancyBackbone.Views.GearInsights.TrafficOverallView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.trafficFancyView = new FancyBackbone.Views.GearInsights.TrafficFancyView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.mostSearchedView = new FancyBackbone.Views.GearInsights.MostSearchedView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.mostImpressionView = new FancyBackbone.Views.GearInsights.MostImpressionView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.mostActiveView = new FancyBackbone.Views.GearInsights.MostActiveView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.mostPopularView = new FancyBackbone.Views.GearInsights.MostPopularView({
        range : that.range,
        dateFrom : that.dateFrom,
        dateTo : that.dateTo,
        sellerId : that.sellerId
      ...
      that.$el.find(".wrapper.traffic-overall").append(that.trafficOverallView.render().$el);
      ...
      that.$el.find(".wrapper.popular").append(that.mostPopularView.render().$el);
