FancyBackbone.Views.GearInsights.TrafficOverallView = FancyBackbone.Views.Base.View.extend({
  ...
  render: function(page) {
    ...
    this.collection.fetch({ data: $.param({ page: page||1}) }).success(function() {
      ...
      if ( data.length === 0 ) {
        ...
        that.$el.append(
          that.setSubview('paging', new FancyBackbone.Views.GearInsights.TrafficOverallPaginationView({
...
FancyBackbone.Views.GearInsights.TrafficOverallPaginationView = FancyBackbone.Views.Base.TemplateView.extend({
...
FancyBackbone.Views.GearInsights.TrafficFancyView = FancyBackbone.Views.Base.View.extend({
  template: FancyBackbone.Utils.loadTemplate('gear_insights_traffic_fancy_view'),
  ...
  render: function(page) {
    ...
    this.collection.fetch({ data: $.param({ page: page||1}) }).success(function() {
      ...
      if ( data.length === 0 ) {
        ...
        that.$el.append(
          that.setSubview('paging', new FancyBackbone.Views.GearInsights.TrafficFancyPaginationView({
            collection: that.collection
          })).render().$el
        );
      }
...
FancyBackbone.Views.GearInsights.TrafficFancyPaginationView = FancyBackbone.Views.Base.TemplateView.extend({
  template: 'insights_section_pagination',
  className : 'paging',
...
FancyBackbone.Views.GearInsights.MostSearchedView = FancyBackbone.Views.Base.View.extend({
...
FancyBackbone.Views.GearInsights.MostSearchedPaginationView = FancyBackbone.Views.Base.TemplateView.extend({
  template: 'insights_section_pagination',
  className : 'paging',
...
FancyBackbone.Views.GearInsights.MostImpressionView = FancyBackbone.Views.Base.View.extend({
  ...
  render: function(page) {
    ...
    this.collection.fetch({ data: $.param({ page: page||1}) }).success(function() {
      ...
      if ( data.length === 0 ) {
        ...
        that.$el.append(
          that.setSubview('paging', new FancyBackbone.Views.GearInsights.MostImpressionPaginationView({
            collection: that.collection
          })).render().$el
        );
      }
...
FancyBackbone.Views.GearInsights.MostImpressionPaginationView = FancyBackbone.Views.Base.TemplateView.extend({
  template: 'insights_section_pagination',
  className : 'paging',
...
FancyBackbone.Views.GearInsights.MostActiveView = FancyBackbone.Views.Base.View.extend({
  ...
  render: function(page) {
    ...
    this.collection.fetch({ data: $.param({ page: page||1}) }).success(function() {
      ...
      if ( data.length === 0 ) {
        ...
        that.$el.append(
          that.setSubview('paging', new FancyBackbone.Views.GearInsights.MostActivePaginationView({
            collection: that.collection
          })).render().$el
        );
      }
...
FancyBackbone.Views.GearInsights.MostActivePaginationView = FancyBackbone.Views.Base.TemplateView.extend({
  template: 'insights_section_pagination',
  className : 'paging',
...
FancyBackbone.Views.GearInsights.MostPopularView = FancyBackbone.Views.Base.View.extend({
  template: FancyBackbone.Utils.loadTemplate('gear_insights_most_popular_view'),
  ...
  render: function(page) {
    ...
    this.collection.fetch({ data: $.param({ page: page||1}) }).success(function() {
      ...
      if ( data.length === 0 ) {
        ...
        that.$el.append(
          that.setSubview('paging', new FancyBackbone.Views.GearInsights.MostPopularPaginationView({
            collection: that.collection
          })).render().$el
        );
      }
...
FancyBackbone.Views.GearInsights.MostPopularPaginationView = FancyBackbone.Views.Base.TemplateView.extend({
  template: 'insights_section_pagination',
  className : 'paging',
...
FancyBackbone.Views.GearInsights.TrafficBySnsView = Backbone.View.extend({
  ...
  initialize: function(options) {
    ...
    this.model = new FancyBackbone.Models.GearInsights.TrafficBySnsData({
      user: window.seller,
      range: this.range,
...
FancyBackbone.Views.GearInsights.TrafficBySearchView = Backbone.View.extend({
...
FancyBackbone.Views.GearInsights.TrafficByCountryView = Backbone.View.extend({
...
FancyBackbone.Views.GearInsights.TopSearchView = Backbone.View.extend({
