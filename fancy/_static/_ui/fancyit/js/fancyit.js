		...
		function fancyIt(e) {
			...
			if(!document.getElementById('fancy_button_style')) {
				...
				attr(link, {
					...
					href : ( document.location.protocol == 'https:' ? 'https://' : 'http://' )+DOMAIN+'/_ui/fancyit/css/fancyit.css?c='+dummy,
					rel  : 'stylesheet',
					type : 'text/css'
				});
			...
			attr(elIframe, {
				...
				src  : ( document.location.protocol == 'https:' ? 'https://' : 'http://' )+DOMAIN+'/fancyit/connect?c='+dummy+"&next="+encodeURIComponent(sNextUrl),
				scrolling    : 'no',
				marginwidth  : '0',
				marginheight : '0',
				frameborder  : '0',
