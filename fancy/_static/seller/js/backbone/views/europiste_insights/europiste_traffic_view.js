...
FancyBackbone.Views.EuropisteInsights.TrafficFancyView = FancyBackbone.Views.Base.View.extend({
  ...
  render: function(page) {
    ...
    this.collection.fetch({ data: $.param({ page: page||1}) }).success(function() {
      ...
      if ( data.length === 0 ) {
        ...
        that.$el.append(
          that.setSubview('paging', new FancyBackbone.Views.EuropisteInsights.TrafficFancyPaginationView({
...
FancyBackbone.Views.EuropisteInsights.TrafficFancyPaginationView = FancyBackbone.Views.Base.TemplateView.extend({
...
FancyBackbone.Views.EuropisteInsights.MostSearchedView = FancyBackbone.Views.Base.View.extend({
  ...
  render: function(page) {
    ...
    this.collection.fetch({ data: $.param({ page: page||1}) }).success(function() {
      ...
      if ( data.length === 0 ) {
        ...
        that.$el.append(
          that.setSubview('paging', new FancyBackbone.Views.EuropisteInsights.TrafficOverallPaginationView({
            collection: that.collection
          })).render().$el
        );
      }
...
FancyBackbone.Views.EuropisteInsights.MostSearchedPaginationView = FancyBackbone.Views.Base.TemplateView.extend({
  template: 'insights_section_pagination',
  className : 'paging',
...
FancyBackbone.Views.EuropisteInsights.MostImpressionView = FancyBackbone.Views.Base.View.extend({
  ...
  render: function(page) {
    ...
    this.collection.fetch({ data: $.param({ page: page||1}) }).success(function() {
      ...
      if ( data.length === 0 ) {
        ...
        that.$el.append(
          that.setSubview('paging', new FancyBackbone.Views.EuropisteInsights.MostImpressionPaginationView({
            collection: that.collection
          })).render().$el
        );
      }
...
FancyBackbone.Views.EuropisteInsights.MostImpressionPaginationView = FancyBackbone.Views.Base.TemplateView.extend({
  template: 'insights_section_pagination',
  className : 'paging',
...
FancyBackbone.Views.EuropisteInsights.MostActiveView = FancyBackbone.Views.Base.View.extend({
  ...
  render: function(page) {
    ...
    this.collection.fetch({ data: $.param({ page: page||1}) }).success(function() {
      ...
      if ( data.length === 0 ) {
        ...
        that.$el.append(
          that.setSubview('paging', new FancyBackbone.Views.EuropisteInsights.MostActivePaginationView({
            collection: that.collection
          })).render().$el
        );
      }
...
FancyBackbone.Views.EuropisteInsights.MostActivePaginationView = FancyBackbone.Views.Base.TemplateView.extend({
  template: 'insights_section_pagination',
  className : 'paging',
...
FancyBackbone.Views.EuropisteInsights.TrafficBySnsView = Backbone.View.extend({
  ...
  initialize: function(options) {
    ...
    this.model = new FancyBackbone.Models.EuropisteInsights.TrafficBySnsData({
      user: window.seller,
      range: this.range,
...
FancyBackbone.Views.EuropisteInsights.TrafficBySearchView = Backbone.View.extend({
...
FancyBackbone.Views.EuropisteInsights.TrafficByCountryView = Backbone.View.extend({
...
FancyBackbone.Views.EuropisteInsights.TopSearchView = Backbone.View.extend({
