	...
	$.extend($.fn, {
		...
		selectBox: function(method, data) {
			...
			var showMenu = function(select) {
				...
				options.show();
				var optionsHeight = options.outerHeight(), optionsTop = control.offset().top + control.outerHeight() - borderBottomWidth, optionsTopUp;
				options.hide();

				if (optionsTop + optionsHeight > $(document).innerHeight()) {
					optionsTopUp = control.offset().top - optionsHeight;
					if (optionsTopUp > 0) optionsTop = optionsTopUp;
				}
